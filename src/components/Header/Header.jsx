            ...
            <nav className="bg-white border-gray-200 px-4 lg:px-6 py-2.5">
                <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                    <Link to="/" className="flex items-center">
                        <img
                            src="https://static.vecteezy.com/system/resources/thumbnails/003/738/383/small/appointment-date-icon-free-vector.jpg"
                            className="mr-3 h-12"
                            alt="Logo"
                        />
                        <h1 className='text-3xl font-bold'>Appointment</h1>
                        <span className='text-3xl font-bold text-blue-700'>Scheduler</span>
                    </Link>
